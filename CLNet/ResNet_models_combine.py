...
import numpy as np
from CLNet.ResNet import B2_ResNet
from CLNet.utils import init_weights,init_weights_orthogonal_normal
device = torch.device('cuda' if torch.cuda.is_available() else 'cpu')
from torch.autograd import Variable
from torch.nn import Parameter, Softmax
import torch.nn.functional as F
from torch.distributions import Normal, Independent, kl
from CLNet.HolisticAttention import HA
import math
...
class Saliency_feat_decoder(nn.Module):
    ...
    def __init__(self, channel,latent_dim):
        ...
        self.br1 = nn.BatchNorm2d(channel)
        self.br2 = nn.BatchNorm2d(channel)
        self.br3 = nn.BatchNorm2d(channel)
        self.br4 = nn.BatchNorm2d(channel)
