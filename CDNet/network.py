...
class Weights(nn.Module):
    ...
    def forward(self, F_Do_5, F_De_5):
        ...
        gap_F_Do_5 = torch.mean(F_Do_5.view(N, 512, 256), dim=2).view(N, 512, 1, 1)  # [N, 512, 1, 1]
        gap_F_De_5 = torch.mean(F_De_5.view(N, 512, 256), dim=2).view(N, 512, 1, 1)  # [N, 512, 1, 1]
...
class High_level_fusion(nn.Module):
    ...
    def forward(self, F_I, F_fuse, vgg_rgb, compr_I):
        ...
        W_d = resize(W_d, target_size=F.max_pool2d(F_I[2], 2).shape[2:])
