...
from HAINet.HolisticAttention import HA
from HAINet.vgg import B2_VGG
...
class HAIM(nn.Module):
    def __init__(self, in_channel):
        ...
        self.rgb_branch1 = BasicConv2d(in_channel, int(in_channel/4), 3, padding=1, dilation=1)
        self.rgb_branch2 = BasicConv2d(in_channel, int(in_channel/4), 3, padding=3, dilation=3)
        self.rgb_branch3 = BasicConv2d(in_channel, int(in_channel/4), 3, padding=5, dilation=5)
        self.rgb_branch4 = BasicConv2d(in_channel, int(in_channel/4), 3, padding=7, dilation=7)

        self.d_branch1 = BasicConv2d(in_channel, int(in_channel/4), 3, padding=1, dilation=1)
        self.d_branch2 = BasicConv2d(in_channel, int(in_channel/4), 3, padding=3, dilation=3)
        self.d_branch3 = BasicConv2d(in_channel, int(in_channel/4), 3, padding=5, dilation=5)
        self.d_branch4 = BasicConv2d(in_channel, int(in_channel/4), 3, padding=7, dilation=7)
        ...
        self.rgb_branch1_ca = ChannelAttention(int(in_channel/4))
        self.rgb_branch2_ca = ChannelAttention(int(in_channel/4))
        self.rgb_branch3_ca = ChannelAttention(int(in_channel/4))
        self.rgb_branch4_ca = ChannelAttention(int(in_channel/4))
        ...
        self.r_branch1_ca = ChannelAttention(int(in_channel/4))
        self.r_branch2_ca = ChannelAttention(int(in_channel/4))
        self.r_branch3_ca = ChannelAttention(int(in_channel/4))
        self.r_branch4_ca = ChannelAttention(int(in_channel/4))
